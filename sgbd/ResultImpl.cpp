...
/* */
void ResultImpl::filterNodes(string entityName, Attribute * attr[], int nAttr, int cmpOp){
...
void ResultImpl::filterEdges(string RelationName, Attribute *attr[], int nAttr, int cmpOp){
...
void ResultImpl::where(string label, Attribute * attr[], int nAttr, int cmpOp){
